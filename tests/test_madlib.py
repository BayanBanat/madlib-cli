...
from madlib_cli.madlib import read_template, parse_template, merge, prompt, welcomeMessage
...
def test_read_template_returns_stripped_string2():
    actual = read_template("assets/original_text.txt")
...
# @pytest.mark.skip("pending")
def test_read_template_raises_exception_with_bad_path2():
